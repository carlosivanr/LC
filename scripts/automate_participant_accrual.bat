...
set r_commands="renv::load('D:/long_covid'); source('D:/long_covid/scripts/render_participant_accrual_report.R')"

:: path to the log output file in windows back slash format
set log_out="D:\long_covid\scripts\participant_accrual_report.log"
