...
set r_commands="renv::load('D:/long_covid'); source('D:/long_covid/patient_data_collection/render_patient_data_collection.R')"

:: path to the log output file in windows back slash format
set log_out="D:\long_covid\patient_data_collection\patient_data_collection_log.log"
